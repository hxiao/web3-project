...
<div class="fieldcontain ${hasErrors(bean: gameInstance, field: 'date', 'error')} required">
	...
	<g:datePicker name="date" precision="day" years="${(baseYear = (Calendar.getInstance().get(Calendar.YEAR) - 1))..(baseYear + 2)}" value="${gameInstance?.date}"  />
</div>
...
<div class="fieldcontain ${hasErrors(bean: gameInstance, field: 'time', 'error')} required">
	...
	<g:timePicker name="time" precision="minute"  value="${gameInstance?.time}"  />
</div>
